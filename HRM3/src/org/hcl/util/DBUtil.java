...
public class DBUtil {
	public static Connection getConnection(String driver,String url,String uname,String password)
	{
		Connection con=null;
		try {
	...
	public static Credentials getCredentials()
	{
		...
		try{
			...
			properties.load(new FileInputStream("C:\\Users\\PREETHY\\eclipse-workspace\\HRM3\\src\\org\\hcl\\util\\database.properties"));
